module NoricMud
  class Mob < MudObject
    ...
    attr_accessor :resting_damage_handler, :meditating_damage_handler, :breath_dead_handler # one of ugliest hacks in mud; physicalstate handlers have no place in Mob; to get rid: i) Seh named handlers; ii) instanced physicalstates, or lambda transitions
  end
end
